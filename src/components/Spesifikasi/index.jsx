...
const Spesifikasi = () => {
  return (
    <div>
      <div className="mx-10">
        <div className="relative mb-20 flex w-full items-center">
          <div className="w-1/2">
            <div className="relative z-10 flex aspect-square w-full items-center">
              <div className="relative aspect-square w-4/5">
                ...
                <div className="absolute -top-[10%] right-5 aspect-[1/3] w-8 rounded-lg bg-[#3B5858] shadow-custom1"></div>
                <div className="absolute -top-[10%] right-16 aspect-[1/3] w-8 rounded-lg bg-[#3B5858] shadow-custom1"></div>
              </div>
            </div>
            <div className="absolute right-1/2 top-0 z-0 h-full w-1/4 bg-primary"></div>
          </div>
          <div className="flex flex-1 items-center bg-primary py-28 pl-10">
            <div className="text-white">
              <h3 className="mb-10 font-dmserif text-6xl leading-snug">
                Spesifikasi
                <br />
                Bangunan
              </h3>
              <div>
                {SpesifikasiList.map((item, index) => (
                  ...
                  >
                    <AiOutlineCheckCircle className="mr-5 text-2xl" />
