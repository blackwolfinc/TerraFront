  ...
  return (
    <>
      <div className="relative">
        <div className="absolute w-full bottom-0 bg-primary h-[50%]"></div>
        <div className="mx-auto max-w-screen-xl">
            <div className="relative">
              <div className="mt-20 flex h-full flex-col items-start justify-center p-10 lg:mt-0 lg:h-64">
                <div className="w-full lg:w-[50%]">
                  <div className="hidden py-4 font-bevietnampro text-3xl font-bold tracking-wide text-primary lg:block">
                    Terra Kota Residance Video
                  </div>
                </div>
              </div>
              <div className="flex h-full flex-col items-start justify-center gap-5 bg-primary p-10 pt-[30%] font-baijamjuree text-white md:pt-[30%] lg:h-64 lg:pt-0 ">
                {/* mobile */}
                <div className="block py-2 font-bevietnampro text-2xl font-bold tracking-widest text-white lg:hidden">
                  Terra Kota Residance Video
                </div>
                {/*  */}
              ...
              <div className="absolute bottom-[65%] w-full sm:px-10 md:bottom-[50%] lg:bottom-[20%] lg:right-0 lg:w-[50%]">
